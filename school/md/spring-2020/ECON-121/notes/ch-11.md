...
zero. Here are the features of monopolistic competition:
  ...
  - _A differentiated product_. Firms engage in [product
    differentiation](ch-11#product-differentiation-term), the process used by
    firms to distinguish their products from the products of competing firms. A
    firm can distinguish its products from the products of other firms by
    offering a different performance level or appearance. For example,
