...
#### Video Lecture Notes
  ...
  - Find one side and one ration to get the two missing sides.
  - From hypotenuse to right sides, multiply hypotenuse by the ratio.
  - From right sides to hypotenuse, divide right side by the ration.

## 4.5 Triangles 30-60 and 45-45
...
#### Video Lecture 1 Notes
  ...
  - If ratios are known, one side is needed.
  - Small angles produces small sides, big angles produces big sides.
  - Across $30^{\circ}$ is the smallest side.
  - Across $60^{\circ}$ is the biggest side.
  - Across $90^{\circ}$ is the hypotenuse side.
  - **30-60 Theorem** [(6:00)](https://www.youtube.com/watch?v=1kz7sxySOnU&t=360)
    * From the small side to hypotenuse, $s \cdot 2 = h$
...
#### Video Lecture 3 Notes
  ...
  - 45-45 triangles produces 2 equal sides.
  - To get the hypotenuse, $h = s\sqrt{2}$, where $s$ is either of the equal
    sides.
