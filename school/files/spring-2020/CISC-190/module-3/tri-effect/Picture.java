...
public class Picture extends SimplePicture
{
  ...
  /** M3 Tri-Effect: Grayscale Method
   * Turns Picture object into grayscale.
   * @param start start location of pixel to filter
   * @param end end location of pixel to filter
   */
  public void grayscale(int start, int end)
  {
    ...
    while (index < end)
    {
      ...
      // Compute the average of the three RGB components to get the grayscal intensity
